...
const SearchBar: React.FC<SearchBarProps> = () => {
  ...
  return (
    <section className="px-6 my-3 flex md:flex-row flex-col w-full md:gap-3">
      <div className="w-full md:w-1/2 lg:w-1/3 relative">
        <input
          ...
          className="w-full text-sm rounded-full border border-gray-700 p-4 text-primary focus:border-primary focus:outline-none pl-12 pr-4"
        />
        <svg
